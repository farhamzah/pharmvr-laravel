...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Services\Ai\Providers\AiProviderInterface' => \App\Services\Ai\Providers\MockAiProvider::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\Flutter\pharmvrpro\backend\public\storage' => 'string',
...
'manage_users','manage_content','manage_news','manage_assessments','view_monitoring',
'view_audit_logs','manage_system','manage-users','manage-content','manage-news',
'manage-assessments','view-monitoring','view-audit-logs','manage-system','access-admin',);
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.E:\\Flutter\\pharmvrpro\\backend\\public\\storage','logging.default',
...
'signed','throttle','verified','admin','permission',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','login','admin.logout','admin.dashboard','admin.users.index','admin.users.create',
'admin.users.store','admin.users.edit','admin.users.update','admin.users.destroy','admin.users.ban',
'admin.users.unban','admin.users.force-logout','admin.education.index','admin.education.create','admin.education.store',
'admin.education.show','admin.education.edit','admin.education.update','admin.education.destroy','admin.education.add-content',
'admin.education.store-content','admin.videos.index','admin.videos.create','admin.videos.store','admin.videos.show',
'admin.videos.edit','admin.videos.update','admin.videos.destroy','admin.videos.toggle','admin.documents.index',
'admin.documents.create','admin.documents.store','admin.documents.show','admin.documents.edit','admin.documents.update',
'admin.documents.destroy','admin.documents.toggle','admin.news.index','admin.news.create','admin.news.store',
'admin.news.show','admin.news.edit','admin.news.update','admin.news.destroy','admin.assessments.index',
'admin.assessments.create','admin.assessments.store','admin.assessments.show','admin.assessments.edit','admin.assessments.update',
'admin.assessments.destroy','admin.assessments.reset-attempts','admin.monitoring.vr','admin.monitoring.vr.detail','admin.monitoring.ai',
'admin.monitoring.progress','admin.reporting.training','admin.reporting.ai','admin.reporting.user-report','admin.audit-logs.index',
'admin.audit-logs.show','admin.settings.index','admin.settings.update','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.assessments.create','admin.assessments.edit','admin.assessments.index','admin.assessments.show','admin.audit-logs.index',
'admin.audit-logs.show','admin.auth.login','admin.dashboard','admin.documents.create','admin.documents.edit',
'admin.documents.index','admin.education.add-content','admin.education.create','admin.education.edit','admin.education.index',
'admin.education.show','admin.monitoring.ai-interactions','admin.monitoring.student-progress','admin.monitoring.vr-session-detail','admin.monitoring.vr-sessions',
'admin.news.create','admin.news.edit','admin.news.index','admin.news.partials._form','admin.news.show',
'admin.reporting.ai-analytics','admin.reporting.training-progress','admin.reporting.user-report','admin.settings.index','admin.users.create',
'admin.users.edit','admin.users.index','admin.videos.create','admin.videos.edit','admin.videos.index',
'components.admin.button','components.admin.card','components.admin.image-upload','components.admin.input-group','errors.429',
'errors.500','layouts.admin','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'E:.Flutter.pharmvrpro.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
