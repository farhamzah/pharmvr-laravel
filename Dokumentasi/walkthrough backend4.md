...
- **Confirmation**: Headsets confirm pairing via `POST /v1/vr/pairings/confirm` using raw codes.
- **Device Masking**: Automatic tracking of `headset_identifier`, `platform_name`, and `app_version`.
