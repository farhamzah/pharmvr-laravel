...
@section('header', 'Add Training Video')
...
<div class="max-w-4xl relative">
    <div class="bg-surface rounded-4xl border border-divider shadow-premium overflow-hidden transition-all hover:border-primary/10">
        <form action="{{ route('admin.videos.store') }}" method="POST" class="p-10">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div class="space-y-3">
                        ...
                        <input type="text" id="title" name="title" value="{{ old('title') }}" required 
                            ...
                            placeholder="e.g., CPOB Part 1: Introduction">
                    </div>
            ...
            <div class="mb-12 pt-10 border-t border-divider">
                ...
                <div class="space-y-8">
                    <div class="space-y-3">
                        ...
                        <p class="text-[9px] text-text-tertiary italic px-1 opacity-60">System will automatically extract video ID and thumbnail.</p>
                    </div>
            ...
            <div class="space-y-3">
                ...
                <textarea id="description" name="description" rows="4" required
                    ...
                    placeholder="Provide a detailed summary of this educational video...">{{ old('description') }}</textarea>
            </div>
