...
<nav class="flex-1 overflow-y-auto px-6 py-4 space-y-8">
    ...
    <div>
        ...
        <div class="space-y-1">
            ...
            <a href="{{ route('admin.vr-scene-layouts.index') }}" class="flex items-center gap-4 px-4 py-3 rounded-2xl {{ request()->routeIs('admin.vr-scene-layouts.*') ? 'bg-primary text-background font-black' : 'text-text-secondary hover:bg-surface-light hover:text-white' }} transition-all duration-300 group">
                <svg class="w-5 h-5 {{ request()->routeIs('admin.vr-scene-layouts.*') ? 'text-background' : 'text-primary/70 group-hover:text-primary' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M4 6a2 2 0 012-2h3l2 2h7a2 2 0 012 2v10a2 2 0 01-2 2H6a2 2 0 01-2-2V6zm4 4h8M8 14h5"></path></svg>
                <span class="text-sm">VR Scene Layouts</span>
            </a>
            @endif
